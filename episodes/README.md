...
| 07  | 2026-09-25 | Shared inbox router — rules-first, drafts only, no send node, 13-row disclosed test fixture                                 | [`workflows/07-inbox-router-drafts-only`](../workflows/07-inbox-router-drafts-only/) | [youtu.be/6eYrSKiPSrU](https://youtu.be/6eYrSKiPSrU) | GHL CSV scheduled 2026-09-26 09:30 — FB reel, IG reel, LinkedIn, TikTok | 88 / 87                | [EP07.md](EP07.md) |
